...
if (length(args)==0) {
  ...
  args[9] = list.files("SCA/data/", "RECODE3/BREAST", "R3-BREAST-*_tpm-mRNA.tsv", full.names=TRUE)
  args[10] = list.files("SCA/data/", "RECODE3/BREAST", "R3-BREAST-*_count-mRNA.tsv", full.names=TRUE)
  args[11] = ""
  arg2[12] = ""
}
...
# glimmaMDS(y,labels=colnames(y$counts), groups=group,
#           html=paste(GOI_label,"MDS-Plot2.html",sep="-",collapse=""), 
#           launch=FALSE, folder = "glimma-plots", width = 500, height = 500)
