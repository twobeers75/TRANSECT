...
if (length(args)==0) {
  ...
  args[8] = list.files("SCA/data/", "RECODE3/BREAST", "R3-BREAST-*_tpm-mRNA.tsv", full.names=TRUE)
  args[9] = list.files("SCA/data/", "RECODE3/BREAST", "R3-BREAST-*_count-mRNA.tsv", full.names=TRUE)
  args[10] = ""
  arg2[11] = ""
}
