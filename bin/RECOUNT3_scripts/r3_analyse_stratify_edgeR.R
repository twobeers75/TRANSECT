...
if (length(args)==0) {
  ...
  args[5] = "/home/jtoubia/Desktop/Projects/SRt/REF_FILES"
	args[6] = list.files(args[2], "RECODE3/BREAST", "R3-BREAST-*_tpm-mRNA.tsv", full.names=TRUE)
	args[7] = list.files(args[2], "RECODE3/BREAST", "R3-BREAST-*_count-mRNA.tsv", full.names=TRUE)
	args[8] = ""
	arg2[9] = ""
}
