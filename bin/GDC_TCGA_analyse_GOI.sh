...
de_analysis( ) {
	...
	Rscript --vanilla ${SCRIPT_FOLDER}/gdc_tcga_analyse_stratify_edgeR.R ${GOI} ${strat_by} ${percentile} ${REF_FILES_FOLDER} ${GSEA_EXE} ${tcga_fpkm[0]} ${tcga_counts[0]} ${tcga_rpm[0]}
	cd ${working_folder}
}
