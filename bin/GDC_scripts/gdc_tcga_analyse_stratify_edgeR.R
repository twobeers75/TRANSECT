...
if (length(args)==0) {
  ...
  args[5] = "/home/jtoubia/Desktop/Projects/SRt/REF_FILES"
	args[6] = list.files(args[2], "BRCA/mRNA_expression_fpkm", "GDC_TCGA-BRCA.*FPKM-mRNA_toTPM_all.tsv", full.names=TRUE)
	args[7] = list.files(args[2], "BRCA/mRNA_expression_counts", "GDC_TCGA-BRCA.*Count-mRNA_all.tsv", full.names=TRUE)
	args[8] = list.files(args[2], "BRCA/isomiR_expression_rpm", "GDC_TCGA-BRCA.*RPM-miRNAisoform_all.tsv", full.names=TRUE)
	args[9] = ""
}
